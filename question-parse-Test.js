testQuestion = {type:"text",
		bodyText:"what is the capital city of New Zealand",
		answersArray:["Wellington"]
		};

var parseItUp(){
	var questionJSON = testQuestion;
	var bodyText = questionJSON["bodyText"];
	
	if(questionJSON["type"].indexOf("text")!=-1){
		var answersArray = questionJSON["answersArray"];
